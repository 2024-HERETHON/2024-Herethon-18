document
  .getElementById("settingToggleContainer")
  .addEventListener("click", function () {
    let settingToggleContainer = this;
    let toggleButton = settingToggleContainer.querySelector(
      ".setting-toggle-btn"
    );
...
// 모달
document
  .getElementById("accout-delete-btn")
...
document
  .getElementById("password-alert-btn")
  .addEventListener("click", function () {
